...
const PasswordPanel = require('./password-panel.jsx')
...
const Copy = () => {
    return <p>Please click on a book to view details in a modal. You can copy/paste the link of the modal. The link will
        open book on a separate page.</p>
}
...
class Index extends React.Component {
    render() {
        return (
            <div>
                <Copy/>
                <p><Link to="/password" className="btn btn-danger">Password</Link></p>
...
ReactDOM.render((
    <Router history={hashHistory}>
        ...
        <Route path="/checkout" component={Checkout}
               cartItems={cartItems} products={PRODUCTS}/>
        <Route path="/password" component={PasswordPanel}/>
    </Router>
